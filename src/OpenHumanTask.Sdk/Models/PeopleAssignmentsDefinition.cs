...
public record PeopleAssignmentsDefinition
{
    ...
    public virtual EquatableList<PeopleReferenceDefinition>? PotentialInitiators { get; set; }
    ...
    public virtual EquatableList<PeopleReferenceDefinition>? PotentialOwners { get; set; }
    ...
    public virtual EquatableList<PeopleReferenceDefinition>? ExcludedOwners { get; set; }
    ...
    public virtual EquatableList<PeopleReferenceDefinition>? Stakeholders { get; set; }
    ...
    public virtual EquatableList<PeopleReferenceDefinition>? BusinessAdministrators { get; set; }
    ...
    public virtual EquatableList<PeopleReferenceDefinition>? NotificationRecipients { get; set; }
    ...
    public virtual EquatableList<LogicalPeopleGroupDefinition>? Groups { get; set; }
